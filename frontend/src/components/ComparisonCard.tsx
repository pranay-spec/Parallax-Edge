...
import { ProductGroup, ProductResult } from '@/types';
...
export default function ComparisonCard({ group, index = 0, onViewAR }: ComparisonCardProps) {
                        ...
                        {expanded && (
                            <div className="space-y-3">
                                {extraProducts.map((product) => (
                                    <ProductCard key={product.id} product={product} onViewAR={onViewAR} />
                                ))}
                            </div>
                        )}
                    </>
